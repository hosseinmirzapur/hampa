    ...
    <div className="container mx-auto px-4 py-6">
      ...
      >
        <div className="p-6 md:p-8">
          <h2 className="text-2xl md:text-3xl font-bold mb-2">دوست همراه پیدا کن!</h2>
          <p className="mb-4">برنامه دویدنت رو ثبت کن و با دونده‌های اطرافت آشنا شو</p>
          ...
          <div className="absolute -left-10 bottom-0 opacity-10">
            <svg width="200" height="100" viewBox="0 0 200 100">
              <path d="M20,50 Q40,40 50,50 T80,50 T110,50 T140,50 T170,50" stroke="white" strokeWidth="3" fill="none" />
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {['پارک لاله', 'بوستان ملت', 'پارک جمشیدیه', 'دریاچه چیتگر', 'پارک آب و آتش', 'دربند'].map((location) => (
            <div 
              key={location}
