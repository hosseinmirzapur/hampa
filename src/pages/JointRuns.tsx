...
import { User, MapPin, Calendar, Clock, Phone, Eye, EyeOff } from 'lucide-react';
...
const JointRuns: React.FC = () => {
  ...
  const myCardsWithInterests = myCards.filter(card => card.interestedUsers.length > 0);
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="bg-gray-50 rounded-lg p-8 text-center">
          ...
          <p className="text-sm text-gray-500">
            برای پیدا کردن همراه دویدن، به کارت‌های دیگران علاقه‌مندی نشان دهید یا کارت جدید ایجاد کنید
          </p>
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      {interestedCards.length > 0 && (
        <div className="mb-8">
          <h2 className="text-lg font-bold mb-4">برنامه‌هایی که به آن‌ها علاقه نشان داده‌اید</h2>
          <div className="space-y-4">
      ...
      {myCardsWithInterests.length > 0 && (
        <div>
          <h2 className="text-lg font-bold mb-4">افرادی که به برنامه‌های شما علاقه نشان داده‌اند</h2>
                ...
                >
                  <div className="p-4">
                    <div className="flex items-center justify-between mb-3">
                      <h3 className="font-bold">برنامه دویدن شما در {card.location}</h3>
                      <button
