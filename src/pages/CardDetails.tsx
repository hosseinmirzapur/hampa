...
import { User, MapPin, Clock, Phone, Calendar, Heart, Users, Share2, ArrowLeft, Eye, EyeOff } from 'lucide-react';
...
const CardDetails: React.FC = () => {
  ...
  const { getCardById, expressInterest, hasExpressedInterest, deleteCard, updateCardVisibility } = useRunnerCards();
  const { user } = useAuth();
    ...
    return (
      <div className="container mx-auto px-4 py-6">
        <div className="bg-white rounded-xl shadow p-6 text-center">
          ...
          <p className="text-gray-600 mb-4">کارت مورد نظر شما وجود ندارد یا حذف شده است</p>
          <button
            onClick={() => navigate(-1)}
  ...
  return (
    <div className="container mx-auto px-4 py-6">
          ...
          <div className="flex flex-wrap gap-2">
            {!isCreator && (
              ...
              >
                ...
                />
                <span className="mr-1">
                  {userHasExpressedInterest ? 'علاقه‌مند شده‌اید' : 'من هم علاقه‌مندم'}
                </span>
              </button>
            )}
            ...
            {isCreator && (
              <>
                ...
                >
                  {card.isPhoneNumberPublic ? <EyeOff size={18} /> : <Eye size={18} />}
                  <span className="mr-1">
                    {card.isPhoneNumberPublic ? 'محرمانه کردن شماره' : 'عمومی کردن شماره'}
                  </span>
                </button>
      ...
      <ConfirmationModal
        ...
        message={card.isPhoneNumberPublic 
